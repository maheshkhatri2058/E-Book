...
const Banner = () => {
  return (
    ...
    <div className='flex w-full flex-col md:flex-row justify-between items-center   gap-12 py-40'>
      ...
      <input type='searc' placeholder='Search book name here' className='px-3 outline-none h-10 mx-2 bg-slate-100 border-2 border-solid border-slate-400 rounded-md placeholder:text-slate-700'></input>
